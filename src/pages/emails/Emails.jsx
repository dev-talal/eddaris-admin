...
import { notificationsColumns, notificationsRows } from '../../components/helpers/tableVariables'
            ...
            <Row>
                <Col lg={6}>
                    <Box className='d-flex'>
                        <SearchBarFilter placeholder="search a email" />
                        <DropdownList style={{width:"140px",textAlign:"left"}} options={['All']} />
                    </Box>
                </Col>
                <Col lg={12} className='mt-4'>
                    <ListTable columns={ notificationsColumns } type={ 'emails' } rows={ notificationsRows }  options={ ['view', 'delete'] } />
                </Col>
            </Row>
        </Box>
    </>
